...
# больше одной строки) и выводит самое частое слово в этом тексте
...
file_name_full= os.path.join(r'c:\Users','jurav','Downloads',file_name)
m=[]
with open(file_name_full) as file1:
    for s in file1:
        m+=[s.split()]
    print(m)
file1.close()
